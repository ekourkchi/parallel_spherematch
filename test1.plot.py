...
for process in processes:
  ...
  filename = 'out.pr.test1.p'+str(int(process))+'.txt'
...
ax.plot([0, 20], [original_time, original_time], '--', markersize = 4, color='black', label="Serial Time",  lw=2) 
ax.plot(processes, omp_time, 'o', markersize = 4, color='blue', label="OMP",  lw=2)
...
ax.annotate('Desktop PC',(6,9), fontsize=14, color='blue')
